...
dog16 = Dog.create(name: "Nasty Misty", age: 8, breed: "Catahoula Leapord Dog", img:"https://s3.amazonaws.com/cdn-origin-etr.akc.org/wp-content/uploads/2017/11/14121408/GettyImages-172454993.jpg", dog_location: "Jackson,MS", adoption_location: "Jackson Humaine Society")
...
adoption1 = Adoption.create(name:"Atlanta Humaine Society", location:"Atlanta, GA", dogs_available: "Skittles, Fugly and Monster", img:"https://atlantahumane.org/wp-content/uploads/2017/08/IMG_7487.jpg",dog_id: 1, user_id: 1)
adoption2 = Adoption.create(name:"Miami Humaine Society", location:"Miami, FL", dogs_available: "Aero and Mustard", img:"https://assets.donordrive.com/HumaneMiami/images/$cms$/100/1024.jpg",dog_id: 2, user_id: 2)
adoption3 = Adoption.create(name:"Columbia Humaine Society", location:"Columbia, SC", dogs_available: "Dallas",img: "https://cghs.org/wp-content/uploads/2015/12/New_Slide_Home.jpg", dog_id: 3, user_id: 3)
adoption4 = Adoption.create(name:"Raleigh Humaine Society", location:"Raleigh, NC", dogs_available: "Grizzly",img: "https://woay.tv/wp-content/uploads/2018/09/27973705_1785217784843459_4357033974644344576_n.jpg",dog_id: 4, user_id: 4)
adoption5 = Adoption.create(name:"Nashville Humaine Society", location:"Nashville,TN",dogs_available: "Danica and Sissy", img: "https://pbs.twimg.com/profile_images/1096052416552681472/UR-CZUnb.png", dog_id: 5, user_id: 5)
adoption6 = Adoption.create(name:"Birmingham Humaine Society", location:"Birmingham, AL", dogs_available: "Kissy and Honey Blue", img:"https://i.pinimg.com/originals/69/3f/e5/693fe5820517cee2d8b04c5de4ec3ba7.jpg", dog_id: 6, user_id: 6)
adoption7 = Adoption.create(name:"Jackson Humaine Society", location:"Jackson, MS", dogs_available: "Nasty Misty", img: "https://www.co.jackson.ms.us/ImageRepository/Document?documentID=343", dog_id: 7, user_id: 7)
adoption8 = Adoption.create(name:"New Orleans Humaine Society", location:"New Orleans, LA", dogs_available: "Beaches and Picasso", img:"https://static.fundrazr.com/campaigns/1169434482304dd28380a27d968982fd.png?v=1?cb=1308870812" ,dog_id: 8, user_id: 8)
adoption9 = Adoption.create(name:"Austin Humaine Society", location:"Austin, TX", dogs_available: "Bloody Mary and King Arthur", img: "http://www.austinhumanesociety.org/wp-content/themes/pets/sites/default/files/custom-logo-img-home_1.png", dog_id: 9, user_id: 9)
adoption1 = Adoption.create(name:"Washington DC Humaine Society", location:"Washington DC",dogs_available: "Pickles and Keaton", img: "https://marylandaldpes.files.wordpress.com/2018/10/humane-society.jpg?w=620",dog_id: 10, user_id: 10)
adoption11 = Adoption.create(name:"Seattle Humaine Society", location: "Seattle, WA", dogs_available: "Duggy and Girlie", img: "http://shs.convio.net/images/content/pagebuilder/10971.gif", dog_id: 11, user_id: 11)
